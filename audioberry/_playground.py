...
def PlayPlaylist(TgtPlaylist):
    ...
    InterfaceMPlayer = subprocess.Popen(args, shell=False, stdin=subprocess.PIPE, stdout=FNULL,
...
def CreateControlFile():
    ...
    try:
        ...
        print
        "[ERROR] Failed to create control file. Please, check path to this file."
        exit(1)
...
def ShowMenu():
    ...
    "-----------------------"
    print
    "Current on-line radio: " + RadioNames[PlaylistTarget]
    print
    " "
    print
    "<p> Play/pause"
...
while True:
    try:
        ...
        print
        "This application is being terminated. Good bye."
        exit(1)
